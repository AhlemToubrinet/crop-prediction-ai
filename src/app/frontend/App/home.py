...
ASSETS_PATH = OUTPUT_PATH / Path(
    r"../src/app/frontend/App/assets/frame2"
)
...
image_image_1 = PhotoImage(file=relative_to_assets("src\app\frontend\App\assets\frame2\image_1.png"))
...
def switch_to_LearnMore():
    ...
    subprocess.Popen(
        [
            sys.executable,
            "src/app/frontend/App/LearnMore.py",
        ]
    )
