...
class CropCSP:
    def __init__(self,problem, crop_db: Dict, current_conditions: Dict, 
...
def main():
    ...
    # Initialize solver
    problem = cropProblem(current_conditions,crop_db)
    solver = CropCSP(crop_db, current_conditions, problem)
